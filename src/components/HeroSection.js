                ...
                <Row className="align-items-center">
                    ...
                    <Col md={6} className="position-relative mt-5 mt-md-0 text-center">
                        <div className={styles.imageContainer}>
                            <Image src="/family.png" alt="Family" width={500} height={400} className="img-fluid" style={{ maxWidth: '100%', height: 'auto' }} />

                            {/* Floating Badges */}
                            <div className={styles.badges}>
                                <div className={`${styles.badge} ${styles.carLoan}`}>
                                    <Image src="/car-icon.png" alt="Car" width={16} height={16} />
                                    Car Loans
                                </div>
                                <div className={`${styles.badge} ${styles.homeLoan}`}>
                                    <Image src="/home-icon.png" alt="Home" width={16} height={16} />
                                    Home Loan
                                </div>
                            </div>
                        </div>
